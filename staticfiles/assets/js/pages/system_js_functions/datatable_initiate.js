...
var KTDatatablesSearchOptionsAdvancedSearch = function() {
	...
	var initTable = function(URL, columnDef_data, columns_data, columnDefs_data, sort_data, rowGroup_data=null,default_query_filter="") {
		...
		const export_excel_url = document.querySelector('#export_excel');

		export_excel_url.href = "/gen/download/excel/"+tabel_name+"?"+q_filter+"&col="+col.slice(0, -1)+default_query_filter.replace(/&amp;/g, '&');
