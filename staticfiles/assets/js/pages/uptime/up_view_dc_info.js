$(document).on('click', '.dc_card_up', function (e) {
    ...
    if (dc == "ALL") {
        var endpoint = '/uptime/get/dc/info';
    }
    else{
        var endpoint = `/uptime/get/dc/info?DataCenter=`+dc;
    }
    ...
    function generate_dc_info_dom() {
        ...
        var paused_table = `<table id="paused_system_table" class="table table-rounded border gy-7 gs-7">
                                <thead>
                                <tr class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200" align="center"><th class="text-gray-700 fs-3 fw-bold" colspan="6">URL in Paused State</th><tr>
