        ...
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function() {
                    ...
                    var f = r.children.push(am5map.MapChart.new(o, {
                        panX: "none",
                        panY: "none",
                        wheelY: "none",
                    ...
                    var c, u = f.children.push(am5.Label.new(o, {
                            text: "United States",
                            fontSize: 14,
                            fontWeight: "500",
                        ...
                        p = f.series.push(am5map.MapPolygonSeries.new(o, {
                    ...
                    p.mapPolygons.template.setAll({
                        ...
                        c && c.set("active", !1), (c = e.target).set("active", !0);
        ...
        i = (a, l) => {
            a.forEach(((o, r) => {
                const i = t.cloneNode(!0),
                    ...
                    f = i.querySelector('[data-kt-table-widget-4="template_total"]'),
                    c = i.querySelector('[data-kt-table-widget-4="template_stock"]'),
                    u = s.getAttribute("data-kt-src-path");
                s.setAttribute("src", u + o.image + ".gif"), n.innerText = o.name, m.innerText = o.description, d.innerText = o.cost, g.innerText = o.qty, f.innerText = o.total, o.stock > 10 ? c.innerHTML = '<div class="badge badge-light-success">In Stock</div>' : c.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>', 1 === a.length || a.length;
            ...
            (e = document.querySelector("#kt_table_widget_4_table")) && ((() => {
                e.querySelectorAll("tbody tr").forEach((e => {
                    const a = e.querySelectorAll("td"),
                        t = moment(a[1].innerHTML, "DD MMM YYYY, LT").format();
                    e.closest('[data-kt-table-widget-4="subtable_template"]') || (a[1].setAttribute("data-order", t), a[1].innerText = moment(t).fromNow())
                }));
