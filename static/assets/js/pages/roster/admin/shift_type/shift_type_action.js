...
$(document).on('click', '#update_shift_btn', function () {
    ...
    var normal_claim = $('#normal_claim_input').val()
    if (normal_claim != '') {data["normal_claim"] = normal_claim}

    var holiday_claim = $('#holiday_claim_input').val()
    if (holiday_claim != '') {data["holiday_claim"] = holiday_claim}
...
$(document).on('click', '#create_shift_btn', function () {
    ...
    var normal_claim = $('#normal_claim_input_cr').val()
    if (normal_claim != '') {data["normal_claim"] = normal_claim}

    var holiday_claim = $('#holiday_claim_input_cr').val()
    if (holiday_claim != '') {data["holiday_claim"] = holiday_claim}
