...
jQuery(document).ready(function() {
    ...
    var columnDef = ['id', 'code', 'name', 'color', 'text_color', 'is_allow_in_preference', 'is_allow_in_dashboard', 'is_leave', 'time_info', 'location', 'normal_claim', 'ordering']
    ...
    var colums = [
                    ...
                    {data: 'normal_claim', name: 'normal_claim'},
                    {data: 'holiday_claim', name: 'holiday_claim'},
