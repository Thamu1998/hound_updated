...
var check_scan_data = function () {
    ...
    var initScan = function () {
        ...
        $('#from_time_label').html($("#kt_daterangepicker_report_date").data('daterangepicker').startDate.format('MMM DD, YYYY HH:mm'));

        $('#to_time_label').html($("#kt_daterangepicker_report_date").data('daterangepicker').endDate.format('MMM DD, YYYY HH:mm'));
        
        var endpoint = `/uptime/downtime/scan?scan_dates=`+report_date_start+`to`+report_date_end;
        ...
        function generate_dom(){
            ...
            Object.keys(scan_data).forEach(function(item, index){
                ...
                var temp_data = {'SID': item, 'chart_div':card_div, 'downCount': scan_data_inst.downCount, 'totalDown': scan_data_inst.totalDown, 'fromTime': scan_data_inst.fromTime};
...
function getUrlVars()
{
    ...
    if (paramString == undefined){
        ...
        from_date.setHours(from_date.getHours() - 3);
...
$('#load_scan_btn').on('click', function(e){
    ...
    var url = `/uptime/downtime?scan_dates=`+report_date_start+`to`+report_date_end;
