...
class acknowledge(object):
    ...
    def system(self, *args, **kwargs):
        try:    
            ...
            init_ack = uptime_time_series_data.objects.get(SID=kwargs['SID'], ToTime=None, IsAcknowledged=False)
    ...
    def database(self, *args, **kwargs):
        ...
        uptime_time_series_data.objects.filter(DataCenter=kwargs['DC'], ToTime=None, IsAcknowledged=False).update(IsAcknowledged=True, acknowledgedBy=kwargs['acknowledgedBy'], acknowledgedAt=timezone.now())
