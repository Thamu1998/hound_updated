...
class downtime_time_series(object):
    ...
    def scan(self, **kwargs):
        ...
        downtime_data = pingdom_time_series_data.objects.values().filter(Q(ToTime__range=(startdate, enddate))|Q(FromTime__range=(startdate, enddate)))
        ...
        for SID,DF in df_groupby:
            ...
            final_dict[SID] = {'downCount':downCount, "BusinessType":DF['BusinessType'].tolist()[0],"DataCenter":DF['DataCenter'].tolist()[0],'fromTime':getminFrom,'totalDown':totalDown,'details':TempList}
