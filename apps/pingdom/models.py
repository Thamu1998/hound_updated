...
class comment_table(models.Model):
    ...
    comment_by = models.ForeignKey(User, related_name='URLComments', on_delete=models.CASCADE)
...
class pingdom_status(models.Model):
    id = models.BigIntegerField(primary_key=True)
    SID = models.CharField(max_length=30, default='')
    DataCenter = models.CharField(max_length=50,default='')
    system_info = models.ForeignKey(system, related_name='sid_info', on_delete=models.CASCADE,blank=True, null=True)
    dc_info = models.ForeignKey(datacenter_decs, related_name='dc_info', on_delete=models.CASCADE,blank=True, null=True)
    ...
    class Meta:
        verbose_name = "Pingdom Status"
        verbose_name_plural = "Pingdom Status"
        indexes = [models.Index(fields=['SID',])]
        ordering = ('SID',)

class pingdom_status_temp(models.Model):
    id = models.BigIntegerField(primary_key=True)
    SID = models.CharField(max_length=30, default='')
    DataCenter = models.CharField(max_length=50,default='')
    system_info = models.ForeignKey(system, related_name='sid_info_temp', on_delete=models.CASCADE,blank=True, null=True)
    dc_info = models.ForeignKey(datacenter_decs, related_name='dc_info_temp', on_delete=models.CASCADE,blank=True, null=True)
    created = models.BigIntegerField(null=True)
    name = models.CharField(max_length=300,null=True)
    hostname = models.CharField(max_length=255,null=True)
    resolution = models.IntegerField(null=True)
...
class pingdom_time_series_data(models.Model):
    SID = models.CharField(max_length=3, default='')
    systemNumber = models.CharField(max_length=18,default='')
    DataCenter = models.CharField(max_length=50,default='')
    BusinessType = models.CharField(max_length=50,default='')
    ...
    class Meta:
        verbose_name = "Pingdom Time Series"
        verbose_name_plural = "Pingdom Time Series"
        indexes = [models.Index(fields=['SID',])]
        ordering = ('SID',)